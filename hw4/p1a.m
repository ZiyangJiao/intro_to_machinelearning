...
[error1,oob_err, test_err] = BaggedTrees(train_x1, train_y1, test_x1, test_y1, numBags);
...
[error2,oob_err, test_err] = BaggedTrees(train_x, train_y, test_x, test_y, numBags);
